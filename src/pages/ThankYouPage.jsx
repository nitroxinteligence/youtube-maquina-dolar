    ...
    <div className="site-shell thank-you-page">
      <main className="thank-you">
        ...
        <section className="thank-you__content">
          ...
          <p>Fique de olho no WhatsApp e no e-mail: nossa equipe já está enviando todas as informações para você participar da Aula Magna. Nos vemos lá!</p>
          <div className="thank-you__whatsapp">
            <p className="thank-you__redirect" aria-live="polite">
              <span>Redirecionamento automático para o WhatsApp em</span>
